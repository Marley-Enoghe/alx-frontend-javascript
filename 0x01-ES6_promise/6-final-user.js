...
export function handleProfileSignup(firstName, lastName, fileName) {
  const userPromise = signUpUser(firstName, lastName); // use for Calling the signUpUser function
  const photoPromise = uploadPhoto(fileName); // used for Calling uploadPhoto function
